...
public class PuzzleOneGLBB : MonoBehaviour, PuzzleHandlerI
{
    ...
    {
        bridge1.DOLocalRotate(new Vector3(-90, 180, 0), 2f).SetEase(ease);
        bridge2.DOLocalRotate(new Vector3(-90, 0, 0), 2f).SetEase(ease);
